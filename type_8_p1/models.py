...
class Constants(BaseConstants):
    ...
    groups_by_cycle_dict = {10:[[[9, 1, 5, 7, 4, 6, 8, 3, 10, 2]],
                                 [[9, 5, 8, 7, 3, 4, 1, 6, 10, 2]],
                                 [[4, 6, 10, 5, 3, 7, 8, 2, 1, 9]],
                                 [[5, 8, 9, 1, 7, 6, 3, 2, 4, 10]],
                                 [[4, 3, 2, 10, 9, 8, 6, 7, 1, 5]],
                                 [[3, 6, 10, 7, 9, 5, 4, 2, 1, 8]],
                                 [[1, 7, 2, 3, 8, 6, 4, 5, 9, 10]],
                                 [[5, 10, 2, 3, 7, 8, 4, 1, 6, 9]],
                                 [[3, 4, 1, 2, 9, 8, 6, 7, 5, 10]],
                                 [[5, 7, 8, 1, 6, 4, 9, 10, 2, 3]],
                                 [[6, 3, 5, 4, 2, 7, 1, 8, 9, 10]]],
                            30: [[[8, 29, 15, 20, 27, 18, 9, 4, 13, 10],
                                  [14, 25, 5, 23, 24, 3, 17, 11, 16, 6],
                                  [21, 28, 22, 2, 26, 7, 30, 12, 1, 19]],
                                 [[23, 2, 11, 10, 24, 19, 1, 4, 29, 3],
                                  [9, 5, 22, 25, 15, 27, 14, 30, 16, 12],
                                  [8, 20, 26, 6, 13, 21, 28, 17, 18, 7]],
                                 [[6, 5, 27, 11, 7, 23, 9, 3, 12, 30],
                                  [21, 28, 10, 15, 4, 25, 17, 19, 22, 2],
                                  [1, 18, 14, 13, 20, 29, 16, 26, 8, 24]],
                                 [[1, 29, 18, 12, 5, 21, 25, 4, 3, 6],
                                  [10, 23, 7, 8, 14, 11, 28, 16, 26, 20],
                                  [13, 17, 22, 30, 15, 2, 19, 24, 9, 27]],
                                 [[16, 23, 14, 19, 11, 26, 8, 4, 29, 5],
                                  [3, 13, 25, 6, 28, 21, 1, 9, 17, 20],
                                  [27, 7, 2, 12, 30, 18, 22, 10, 24, 15]],
                                 [[23, 11, 2, 15, 27, 26, 10, 14, 29, 12],
                                  [18, 30, 5, 6, 3, 28, 17, 7, 21, 13],
                                  [20, 4, 16, 24, 25, 22, 9, 1, 19, 8]],
                                 [[17, 26, 14, 20, 1, 7, 9, 30, 18, 2],
                                  [19, 28, 12, 29, 23, 11, 5, 22, 3, 16],
                                  [6, 25, 24, 8, 10, 15, 21, 13, 27, 4]],
                                 [[1, 8, 2, 20, 24, 29, 7, 5, 27, 19],
                                  [18, 22, 26, 30, 17, 11, 16, 14, 28, 6],
                                  [3, 15, 4, 12, 25, 9, 21, 10, 23, 13]],
                                 [[18, 19, 24, 22, 3, 9, 27, 1, 20, 13],
                                  [5, 29, 23, 4, 25, 30, 7, 28, 8, 26],
                                  [11, 16, 21, 10, 6, 17, 14, 12, 2, 15]],
                                 [[12, 7, 21, 14, 18, 27, 25, 26, 13, 8],
                                  [17, 30, 23, 19, 9, 24, 4, 3, 11, 28],
                                  [20, 5, 15, 1, 22, 16, 10, 6, 2, 29]],
                                 [[17, 7, 25, 11, 10, 4, 21, 23, 1, 3],
                                  [18, 28, 12, 30, 26, 24, 6, 8, 29, 15],
                                  [22, 13, 5, 9, 27, 20, 19, 14, 2, 16]]]}
