...
# Changes num_rounds = 60
# Results javascript set 75<=
# Groups groups = groups_by_cycle[self.session.get_participants()[0].vars['p1_cycle']-1]
# add one grouping to groups lists
...
class Constants(BaseConstants):
    ...
    instructions_template = 'type_8_p1/Instructions.html'
    ...
    groups_by_cycle_dict = {10:[[[7, 9, 5, 6, 10, 2, 4, 8, 3, 1]],
                                 [[4, 1, 6, 10, 2, 7, 8, 3, 5, 9]],
                                 [[2, 4, 5, 8, 6, 7, 3, 10, 9, 1]],
                                 [[9, 2, 1, 8, 3, 10, 5, 4, 7, 6]],
                                 [[10, 3, 5, 8, 1, 9, 4, 7, 2, 6]],
                                 [[5, 9, 7, 10, 6, 8, 2, 1, 3, 4]],
                                 [[2, 5, 7, 9, 1, 10, 8, 4, 3, 6]],
                                 [[7, 5, 3, 10, 4, 6, 9, 1, 8, 2]],
                                 [[9, 5, 3, 10, 6, 2, 4, 7, 8, 1]],
                                 [[3, 2, 6, 5, 4, 8, 1, 10, 9, 7]],
                                 [[2, 3, 9, 10, 8, 4, 1, 5, 7, 6]]],
                            30: [[[4, 1, 15, 8, 21, 14, 18, 22, 24, 9],
                                  [20, 11, 2, 27, 23, 10, 16, 3, 13, 6],
                                  [17, 12, 26, 19, 29, 25, 28, 30, 5, 7]],
                                 [[29, 18, 7, 9, 8, 25, 11, 12, 17, 5],
                                  [27, 28, 10, 15, 19, 22, 30, 13, 26, 23],
                                  [4, 24, 1, 14, 3, 16, 6, 20, 2, 21]],
                                 [[18, 14, 11, 12, 13, 23, 19, 30, 6, 15],
                                  [25, 10, 2, 7, 20, 9, 17, 1, 29, 16],
                                  [3, 5, 28, 4, 27, 22, 8, 21, 26, 24]],
                                 [[28, 25, 16, 2, 11, 20, 22, 10, 14, 9],
                                  [17, 27, 12, 23, 18, 8, 6, 24, 26, 19],
                                  [29, 3, 5, 13, 30, 7, 15, 21, 1, 4]],
                                 [[28, 6, 15, 10, 19, 26, 13, 12, 24, 16],
                                  [8, 21, 14, 29, 27, 20, 17, 3, 1, 2],
                                  [5, 9, 25, 30, 4, 11, 7, 22, 18, 23]],
                                 [[27, 1, 5, 13, 20, 26, 7, 19, 21, 11],
                                  [4, 16, 14, 28, 25, 10, 2, 24, 30, 18],
                                  [23, 29, 17, 8, 9, 6, 3, 15, 12, 22]],
                                 [[8, 29, 2, 4, 1, 15, 23, 3, 7, 21],
                                  [22, 16, 17, 13, 30, 5, 26, 25, 27, 28],
                                  [6, 20, 14, 24, 12, 18, 9, 10, 11, 19]],
                                 [[30, 6, 27, 20, 4, 17, 2, 12, 1, 28],
                                  [15, 25, 14, 22, 29, 7, 18, 21, 8, 10],
                                  [19, 24, 16, 3, 9, 5, 11, 26, 23, 13]],
                                 [[2, 9, 16, 10, 5, 1, 24, 19, 12, 3],
                                  [23, 8, 6, 11, 15, 13, 29, 30, 7, 22],
                                  [18, 17, 28, 25, 20, 4, 27, 21, 14, 26]],
                                 [[23, 18, 28, 2, 8, 1, 3, 17, 26, 7],
                                  [13, 10, 30, 24, 9, 12, 14, 4, 15, 19],
                                  [27, 22, 21, 16, 20, 25, 11, 6, 29, 5]],
                                 [[8, 17, 22, 23, 21, 5, 1, 12, 7, 16],
                                  [18, 24, 30, 15, 29, 11, 6, 28, 19, 26],
                                  [2, 3, 4, 14, 13, 10, 20, 25, 9, 27]]]}
...
class Subsession(BaseSubsession):
    ...
    #def set_groups(self):
    #    groups = Constants.groups_by_cycle_dict[len(self.session.get_participants())][self.session.get_participants()[0].vars['p2_cycle']]
    #    print(groups)
...
class Player(BasePlayer):
    ...
    def set_payoff(self):
        payoff_matrix = {
            'Green':{'All 9 Green': Constants.cooperate_payoff,
                 'Any of 9 Red': Constants.betrayed_payoff},
            'Red':{'All 9 Green': Constants.betray_payoff,
                 'Any of 9 Red': Constants.defect_payoff}
        }
