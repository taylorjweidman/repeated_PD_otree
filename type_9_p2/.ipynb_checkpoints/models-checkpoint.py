...
class Constants(BaseConstants):
    ...
    instructions_template = 'type_9_p2/Instructions.html'
...
class Player(BasePlayer):
    ...
    def set_payoff(self):
        payoff_matrix = {
            'Green':{'Any of 3 Green': Constants.cooperate_payoff,
                 'All 3 Red': Constants.betrayed_payoff},
            'Red':{'Any of 3 Green': Constants.betray_payoff,
                 'All 3 Red': Constants.defect_payoff}
        }
